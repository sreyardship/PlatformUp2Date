 ...
 * by the factory that constructs it. Per-app failure isolation lives in the scrape loop, so an
 * implementation is free to throw on an unreachable or unparseable upstream.
 */
