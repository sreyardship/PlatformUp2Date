 ...
 * directly with a ready (fake) {@link CurrentVersionClient}, a {@code version-key} JSON Pointer, and
 ...
 * {@code CurrentVersionClientFactory} now and is exercised separately at the integration level.
 *
...
class HttpCurrentSourceTests {
    ...
    private static CurrentVersionClient fakeClient(JsonNode body) {
        return () -> body;
    }
}
