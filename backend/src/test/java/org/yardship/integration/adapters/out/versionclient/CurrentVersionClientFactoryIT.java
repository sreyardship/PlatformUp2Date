...
/**
 * Integration test for the real {@link CurrentVersionClientFactory} collaborator — the only
 * Arc-bound piece left after {@code HttpCurrentSource} became a pure POJO. Verifies it builds a
 * working {@link CurrentVersionClient} for a given base URL, with the existing
 * {@link org.yardship.adapters.out.versionclient.VersionResponseExceptionMapper} registered so a
 ...
 */
@QuarkusTest
class CurrentVersionClientFactoryIT {
