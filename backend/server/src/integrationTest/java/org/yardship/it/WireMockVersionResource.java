...
public class WireMockVersionResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        // Reproduce GitHub's repository move exactly: the initial releases request redirects to
        // the numeric repository endpoint, preserving the per_page query parameter.
