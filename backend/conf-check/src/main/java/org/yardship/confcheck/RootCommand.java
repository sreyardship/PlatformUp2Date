...
/**
 * Composition root for the regex, pointer, header, metric, changelog, calver, and config subcommands.
 */
@Command(name = "conf-check", mixinStandardHelpOptions = true,
        subcommands = {RegexCommand.class, PointerCommand.class, HeaderCommand.class, MetricCommand.class,
                ChangelogCommand.class, CalverCommand.class, ConfigCommand.class})
