 ...
 * (--url <U> | --body-file <F> | -)}
 *
 * <p>Obtains the body via the {@link org.yardship.cli.port.BodySource} port (live {@code --url}
 * fetch via {@link org.yardship.cli.adapter.LiveHttpBodySource}, or offline
 * {@code --body-file}/stdin via {@link org.yardship.cli.adapter.OfflineBodySource} — exactly one
 * required), builds a {@link org.yardship.cli.version.VersionSpec} from {@code --scheme}/
 * {@code --calver-format}, runs {@link org.yardship.cli.validation.RegexExtractionValidation}, and
 * renders the {@link org.yardship.cli.outcome.ValidationOutcome} via
 * {@link org.yardship.cli.render.ReportRenderer}, returning its exit code.
 *
