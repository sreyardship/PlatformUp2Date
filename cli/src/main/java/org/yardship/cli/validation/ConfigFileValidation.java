package org.yardship.cli.validation;
 ...
 * {@link org.yardship.cli.outcome.SurfaceResult#skippedOffline}. changelog/calver are pure-function
 ...
 * surface) is {@link org.yardship.cli.outcome.SurfaceResult#notApplicable}, independent of
 * {@code offline}.
 */
public final class ConfigFileValidation {
     ...
     *                          org.yardship.cli.command.ConfigCommand}) supplies the concrete adapter
     ...
     *         {@link org.yardship.cli.outcome.AppValidationResult} per app in {@code apps}, in the
     *         same order.
     */
