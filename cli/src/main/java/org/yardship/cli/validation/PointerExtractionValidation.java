 ...
 *       {@link org.yardship.cli.outcome.PointerResult} attempted — extraction never got a node to
 *       resolve against).</li>
 ...
 *       with a {@link org.yardship.cli.outcome.PointerResult#extractedOnly extraction-only}
 *       result.</li>
